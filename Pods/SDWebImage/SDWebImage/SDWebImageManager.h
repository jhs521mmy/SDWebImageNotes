...
typedef NS_OPTIONS(NSUInteger, SDWebImageOptions) {
     ...
     * 表示低优先级，UI交互期间可能会延迟下载，比如当UIScrollView在减速时延迟下载
     */
     ...
     * 表示渐进式的下载和显示，SD默认是把图片全部下载后再显示出来，但是传入该参数可以做到下载一部分图片后先显示这一部分，也就是边下载边显示，如加载一个人体的照片，先看到头，再看到肩膀，最后看到腿。当然这种下载图片的方式需要服务器的支持才行。
     */
